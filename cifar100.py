...
model = CascadeBoostingClassifier(loss = "multinomial", n_layers=100, n_estimators = 10, max_depth=2 , n_iter_no_change = None, validation_fraction = 0.1, learning_rate = 0.1,hidden_size = 8,verbose=1, n_trees=1,batch_size = 500,max_features=0.3)
