declare -a n_trees=("1" "2" "4" "8" "16" "32")
#declare -a n_trees=("4")
declare -a hs=("1" "2" "3" "5" "10")
#declare -a hs=("3")
#declare -a max_depth=("1" "2")
declare -a max_depth=("1" "2")
#declare -a layers=("1" "3" "5" "10")
declare -a layers=("1" "3" "5" "10" "50" "100")
            ...
            for arg5 in "${layers[@]}"; do
                for arg6 in "${datasets[@]}"; do
                    for arg7 in "${models[@]}"; do
                        ...
                        python3 standard_datasets.py --n_trees ${arg2} --hs ${arg3} --max_depth ${arg4} --layers ${arg5} --dataset ${arg6} --model ${arg7}
                    done    
                done    
            done
        done    
